...
|PORTA-6|(未使用)|オーディオミュート (今回は不使用。将来的に本体側にミュート制御機能を設ける可能性あり)|
|PORTA-7|LCIO71|ファンクションスイッチ (本体側の L/R バンパー両方を割り当て)|
|PORTB-0|LCIO72|A ボタン (本体側は B ボタン)|
|PORTB-1|LCIO73|B ボタン (本体側は A ボタン)|
|PORTB-2|LCIO74|Y ボタン (本体側は X ボタン)|
|PORTB-3|LCIO75|X ボタン (本体側は Y ボタン)|
|PORTB-4|LCIO76|上キー|
|PORTB-5|LCIO77|下キー|
|PORTB-6|LCIO78|左キー|
|PORTB-7|LCIO79|右キー|
