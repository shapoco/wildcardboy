...
仕様は `spec/` 配下に分割して置いている。

| ファイル | 内容 |
|---|---|
| [spec/00_overview.md](spec/00_overview.md) | コンセプト、ホストシェル機能 |
| [spec/01_host_interfaces.md](spec/01_host_interfaces.md) | ホストシェル側インタフェース (キーパッド、LCD、TF カード、オーディオ、電源) |
| [spec/02_wildcardbus.md](spec/02_wildcardbus.md) | ロジックカード I/F (WildCardBus) のピン配置と各 I/F の固定割り当て |
